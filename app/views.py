...
def processCustomizationPlanQuote():
    ...
    if request_data:
        ...
        msg = Message('a new customer has requested an ERPNexto customization plan quote... customer mail is '+email+' customer phone is '+phone+' company company name is '+companyName+'',  sender = 'mohamedyossif577@gmail.com', recipients = ['mohamedyossif577@gmail.com'])
